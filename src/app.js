...
app.use('/api/v1/admin', adminAuthentication);
app.post('/api/v1/admin/faculties', validate(facultyCreationValidation), catchAsync(adminController.createFaculty));
app.post('/api/v1/admin/careers', validate(careerCreationValidation), catchAsync(adminController.createCareer));
app.post('/api/v1/admin/questions', validate(questionCreationValidation), catchAsync(adminController.createQuestion));
